$(function () {
    ...
    // 加载数据
    $.ajax({
        url:"/manager/line/related/operator/list",
        data:"lineId=" + lineId,
        dataType:"html",
    ...
    function relateAction(data, dataArray, myModal) {
        $.ajax({
            url:"/manager/line/operator/relate/do",
            data:data,
            dataType:"json",
    ...
    function relateCancelAction(data, dataArray, myModal) {
        $.ajax({
            url:"/manager/line/operator/relate/cancel",
            data:data,
            dataType:"json",
            success:function (msg) {
                setTimeout(function () {
    ...
    $(document).on("click", ".btn-relate", function () {
        ...
        var data = "lineId=" + lineId + "&operatorIds=" + operatorId;
        var dataArray = new Array();
        dataArray.push(operatorId);
        var myModal = $("#process_modal").modal({
            backdrop:'static',
            keyboard:false
        });
