$(function () {
    ...
    // 客户线路设置
    $(document).on("click", ".custom-line-setting", function () {
        window.location.href = "/manager/line/custom/list/index";
    });
    ...
    $(document).on("click", ".btn-related-custom", function () {
        ...
        window.location.href = encodeURI("/manager/line/related/custom/show?lineId=" + lineId + "&lineName=" + lineName);
    });
    ...
    $(document).on("click", ".btn-related-transit", function () {
        ...
        window.location.href = encodeURI("/manager/line/related/transfer/show?lineId=" + lineId + "&lineName=" + lineName + "&curTransferId=" + curTransferId);
    });
    ...
    $(document).on("click", ".btn-related-operator", function () {
        var lineId = $(this).attr("lineId");
        var lineName = $(this).attr("lineName");
        window.location.href = encodeURI("/manager/line/related/operator/show?lineId=" + lineId + "&lineName=" + lineName);
    });
