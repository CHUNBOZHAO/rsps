...
public class ManagerEnterpriseController {
     ...
     * @return
     */
    @RequestMapping("/enterprise/topology/index")
    public String topologyIndex() {
        return "manager/enterprise/enterprise_topo";
    }
}
