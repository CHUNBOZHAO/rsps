...
public interface LineDao {
     ...
     * @return
     */
    Integer countCustoms(@Param("search") String search,
     ...
     * @return
     */
    Integer countUnrelatedCustoms(@Param("entId") String entId,
                                  @Param("entCode") String entCode);
     ...
     * @return
     */
    List<CustomerInfo> queryCustoms(@Param("start") Integer start,
     ...
     * @return
     */
    List<CustomLineInfo> queryCustomRelatedLine(@Param("entCode") String entCode,
                                                @Param("customIds") List<String> customIds);
     ...
     * @return
     */
    List<LineInfo> queryAssociatedLine(@Param("customId") String customId,
                                       @Param("userIds") List<String> userIds,
                                       @Param("entCode") String entCode);
