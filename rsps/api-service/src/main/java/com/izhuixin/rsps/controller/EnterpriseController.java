...
public class EnterpriseController {
    ...
    public boolean checkEntName(String entName,String entId){
        ...
        return enterpriseService.checkEntName(entName,entId);
    }
    ...
    public boolean deleteEnterpriseAndUser(String entId,String userId){
        return enterpriseService.deleteEnterprise(entId,userId);
    }
    ...
    public EnterpriseInfo getEnterpriseAndUserInfoByEntName(String entName){
        return enterpriseService.getEnterpriseInfoByEntName(entName);
    }
}
