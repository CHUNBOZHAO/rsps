$(function () {
    ...
    $(".address-book-span").click(function () {
        ...
        var boxDetail = $("#box_detail").val();
        window.location.href = "/custom/order/showAddressBook?addressType=" + type + "&boxDetail=" + boxDetail;
    });

    // 选择包装箱
    $("#box_select").click(function () {
        var boxDetail = $("#box_detail").val();
        window.location.href = "/custom/order/showBoxType?boxDetail=" + boxDetail;
    });
    ...
    $("#senderInfo").focus(function () {
        var boxDetail = $("#box_detail").val();
        window.location.href = "/custom/order/showInputAddress?addressType=1&boxDetail=" + boxDetail;
    });

    // 收件人输入框点击
    $("#receiverInfo").focus(function () {
        var boxDetail = $("#box_detail").val();
        window.location.href = "/custom/order/showInputAddress?addressType=2&boxDetail=" + boxDetail;
    });
